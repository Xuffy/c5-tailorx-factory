    ...
    <div class="oli-box">
      <blockquote class="quote-box">
        ...
        <div style="position: absolute;right: 20px;top: 8px">
          ...
          <el-button type="primary"
                     ...
                     @click="showOperateFormBox(2,taskInfo.isRework == 1 || taskInfo.isRework == 2 || taskInfo.isRework == 4 ? 1 : 0)">
            分配
          </el-button>
          <el-button type="primary"
      ...
      <fieldset class="field-box basic-info" id="basic-info">
        ...
        <ul>
          ...
          <li>服装类型：
            <span
              v-text="((orderInfo.genderTagName ? '-' + orderInfo.genderTagName : '') +
          (orderInfo.typeTagName ? '-' + orderInfo.typeTagName : '') +
          (orderInfo.seasonTagName ? '-' + orderInfo.seasonTagName : '')).replace('-','')"></span>
          </li>
          <li>定制数量：<span v-text="taskInfo.orderQuantity + '件'"></span></li>
          <li>订单等级：<span v-text="orderInfo.orderGrade"></span></li>
      ...
      <fieldset class="field-box" id="field-img" style="margin: 10px;" v-bind:class="{'tx-hide':showPrintPreview}">
        ...
        <p style="cursor: pointer;color: rgb(0, 102, 204)"
           v-for="item in taskInfo.cadUrlSize">
          ...
          <span v-text="'尺寸：' + item.sizeStr" style="color: #333"></span>
        </p>
      </fieldset>
