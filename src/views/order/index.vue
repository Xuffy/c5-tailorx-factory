  ...
  <div class="order-list tx-content-box">
    <div class="top-box">
      <el-form :inline="true" :model="queryForm" label-width="70px">
        ...
        <el-form-item label="订单等级">
          <el-select v-model="queryForm.orderGrade" clearable placeholder="订单等级" style="width: 243px">
    ...
    <div class="list-box">
      <table class="tx-table" width="100%">
        ...
        <tr v-for="(item,index) in listData">
          ...
          <td v-text="item.orderGrade || '-'"></td>
          <td v-text="item.rankNum || '-'"></td>
          <td v-text="item.fitting"></td>
          <td v-text="item.old_tacheId == 17 ? item.factoryTacheName : item.tacheId"></td>
          <td v-text="((item.genderTagName ? '-' + item.genderTagName : '') +
          (item.typeTagName ? '-' + item.typeTagName : '') +
          (item.seasonTagName ? '-' + item.seasonTagName : '')).replace('-','') || '-'"></td>
          ...
          <td v-text="item.taskOrderCreateDate" class="tx-md-hide"></td>
          ...
          <td>
            ...
            <el-button type="text" size="small"
                       ...
                       @click="showOperateFormBox(2,item,item.isAllocationTache == 1 || item.isAllocationTache == 2 || item.isAllocationTache == 4 ? 1 : 0)">
              分配
            </el-button>
            <el-button type="text" size="small"
                       style="color: #0066CC"
