  ...
  <div class="pad-index" id="pad-index">
    ...
    <header class="pad-header">
      ...
      <div class="search-box">
        <form>
          ...
          <!--<input typeof="text" style="display: none">-->
        </form>
      </div>
    </header>
    ...
    <section class="content-box">
      ...
      <div id="measure">
        ...
        <table class="tx-table measure-table" width="50%">
          <tr>
            <th width="50%">上衣</th>
            <th width="50%">成衣尺寸</th>
          </tr>
        ...
        <table class="tx-table measure-table" width="50%" style="border-left:none">
          <tr>
        ...
        <table class="tx-table body-table" width="50%">
    ...
    <el-tabs v-model="activeName">
      ...
      <el-tab-pane label="量体表" name="second">
        <h3 class="title">设计尺寸表</h3>
        <table class="tx-table measure-table" width="100%">
          <tr>
            <th width="25%">上衣</th>
            <th width="25%">净寸</th>
...
<style scoped>
  ...
  .pad-index table.tx-table {
    margin-top: 24px;
  }

  .pad-index table.tx-table tr:first-child,
  .pad-index table.tx-table tr th,
  .pad-index table.tx-table tr td,
  .pad-index .tx-table {
    border-color: #e5e5e5;
  }
  ...
  .pad-index table.tx-table tr td:nth-child(2n) {
    background-color: #ffffff;
  }
  ...
  .pad-index table.tx-table:last-child {
    border-left: none;
  }
